			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemomj70-display": {
								"semanticObject": "comdemomj70",
								"action": "display",
								"description": "Custom App for Employee",
								"title": "SAP UI5 Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.mj70",
									"url": sap.ui.require.toUrl("com/demo/mj70")
								}
							}
						}
					}
